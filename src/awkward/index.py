...
class Index:
    ...
    def __array__(
        ...
        return ak._nplikes.numpy.Numpy.instance().asarray(
            *maybe_materialize(self._data), dtype=dtype, copy=copy
        )

    def __cupy_get_ndarray__(self) -> ArrayLike:
        return ak._nplikes.cupy.Cupy.instance().asarray(*maybe_materialize(self._data))

    def __jax_array__(self) -> ArrayLike:
        return ak._nplikes.jax.Jax.instance().asarray(*maybe_materialize(self._data))
